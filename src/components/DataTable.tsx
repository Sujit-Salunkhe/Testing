...
const FROZEN_TABLE_MAX_HEIGHT = 200;
...
const ActiveCellDisplay = memo<{
  ...
  // Adjust row index for display (account for frozen rows)
...
export default function GridWithCellInfo() {
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      >
        <strong>✅ True Frozen Rows:</strong> The top {frozenRowCount} row(s) will
        stay fixed at the top while you scroll through the rest of the data.
      </div>

      {/* Container for both frozen and scrollable sections */}
      <div style={{ border: "1px solid #ddd", borderRadius: 4, overflow: "hidden" }}>
        {/* Frozen Rows Table - Stays at top */}
        {frozenRowCount > 0 && (
          <div
            style={{
              position: "sticky",
              ...
              maxHeight: FROZEN_TABLE_MAX_HEIGHT,
              overflowY: "auto",
            }}
          >
            <table
                    ...
                    {row.map((cell, colIdx) => (
                      <td
                        ...
                        style={{
                          ...
                          border: "1px solid #ddd",
                          fontWeight: 600,
                          minWidth: columns[colIdx]?.width || DEFAULT_COLUMN_WIDTH,
                          maxWidth: columns[colIdx]?.width || DEFAULT_COLUMN_WIDTH,
                          overflow: "hidden",
