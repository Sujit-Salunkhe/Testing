...
export default function GridWithCellInfo() {
  ...
  // Extract the active cell from the selection
  ...
  return (
    <div>
      <input
        type="text"
        value={activeCell ? getColumnLetter(activeCell[0]) : "0"}
        onChange={(e) => {
          const letter = e.target.value.toUpperCase();
          const colIndex = letter.charCodeAt(0) - 65;
          if (activeCell && colIndex >= 0) {
            setActiveCell([colIndex, activeCell[1]]);
          }
        }}
      />
      Column
      <input
        type="number"
        value={activeCell ? activeCell[1] + 1 : 0}
        onChange={(e) => {
          const rowNum = parseInt(e.target.value, 10) - 1;
          if (activeCell && !isNaN(rowNum) && rowNum >= 0) {
            setActiveCell([activeCell[0], rowNum]);
          }
        }}
      />
      Row
      ...
      >
        {activeCell
          ? `Row ${activeCell[1] + 1}, Column ${getColumnLetter(
              activeCell[0]
